...
@section('content')
    ...
    <div class="inner-intro parallax bg-overlay-black-70" style="background-image: url({{asset('html/the-zayka/images/bg/03.jpg')}})">
        <div class="container">
                                        ...
                                        <div class="masonry-item clearfix">
                                            <div  class="blog-entry">
                                                <div class="blog-entry-image">
                                                    <img  style="width: 100%; height: 100%; object-fit: contain" alt="" src="{{asset('storage/'.$product->image)}}">
                                                </div>
                                                <div style=" border: 1px; border-style: solid; border-color: #e5e5e5" class="entry-content border ">
                                                    <div class="entry-title">
                                                        <h3><a href="html/the-zayka/blog-single-01.html">{{ucwords($product->name)}}</a></h3>
                                                    </div>
                        ...
                        <div class="sidebar-widget">
                            ...
                            <div class="widget-link">
                                <ul>
                                    ...
                                    <li><a href="{{route('productsbycategory', ['id' => $category->id])}}"> <i class="fa fa-angle-right"></i> {{ucwords($category->name)}} </a></li>
                                    @empty
                                    @endforelse
                                    </ul>
                            </div>
