      ...
      @endif
          ...
          <li class="active"><a class="sidebar-header" href="#"><i
              ...
              <ul class="sidebar-submenu">
                  ...
                  <li><a class="active" href="{{route('data_uploadings.create')}}"><i class="fa fa-circle"></i>Add New</a></li>
              </ul>
          </li>
          <li class="active"><a class="sidebar-header" href="#"><i
              ...
              <ul class="sidebar-submenu">
                  ...
                  <li><a class="active" href="{{route('posts.create')}}"><i class="fa fa-circle"></i>Add New</a></li>
              </ul>
          </li>
          <li class="active"><a class="sidebar-header" href="#"><i
