...
<head>
    ...
    <meta name="keywords" content="Mepal foods" />
    <meta name="description" content="Mepal foods - We bake with passion" />
    <meta name="author" content="" />
    <meta name="viewport" content="width=device-width, initial-scale=1, maximum-scale=1" />
    <title> Mepal food & bakers - We bake with passion</title>
    <!-- Favicon -->
    <link rel="shortcut icon" href="{{asset('assets/images/logo/logo.png')}}" />
    <!-- bootstrap -->
    <link rel="stylesheet" type="text/css" href="html/the-zayka/css/bootstrap.min.css" />
    <!-- google font -->
    ...
    <!-- flaticon -->
    <link rel="stylesheet" type="text/css" href="html/the-zayka/css/flaticon.css" />
    <!-- font awesome -->
    <link rel="stylesheet" type="text/css" href="html/the-zayka/css/font-awesome.min.css" />
    <!-- mega menu -->
    <link rel="stylesheet" type="text/css" href="html/the-zayka/css/mega-menu/mega_menu.css" />
    <!-- carousel -->
    <link rel="stylesheet" type="text/css" href="html/the-zayka/css/owl.carousel.css" />
    <!-- datepicker -->
    <link rel="stylesheet" type="text/css" href="html/the-zayka/css/bootstrap-datetimepicker.min.css" />
    <!-- book -->
    <link rel="stylesheet" type="text/css" href="html/the-zayka/css/book/component.css" />
    <!-- revolution slider -->
    <link rel="stylesheet" type="text/css" href="html/the-zayka/revolution/css/settings.css">
    <link rel="stylesheet" type="text/css" href="html/the-zayka/revolution/css/navigation.css">
    <!-- main style -->
    <link rel="stylesheet" type="text/css" href="html/the-zayka/css/style.css" />
    <!-- responsive -->
    <link rel="stylesheet" type="text/css" href="html/the-zayka/css/responsive.css">
    <!-- Style customizer -->
    <link rel="stylesheet" type="text/css" href="#" data-style="styles" />
    <link rel="stylesheet" type="text/css" href="html/the-zayka/css/style-customizer.css" />
    <!-- Google Tag Manager -->
            ...
            <div class="row">
                <div class="col-lg-6 col-md-6 col-sm-6">
                    <div class="topbar-left text-left">
                        <ul>
                            <li><i class="fa fa-phone"></i> + 92 335 0557570 </li>
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-lg-12 col-md-12">
                            ...
                            {{--                                    <!-- drop down multilevel  -->--}}
                            {{--                                    <ul class="drop-down-multilevel">--}}
                            {{--                                        <li><a href="index.html">menu style 1</a></li>--}}
                            {{--                                        <li><a href="index.html">menu style 2</a></li>--}}
                            {{--                                        <li><a href="index.html">menu style 3</a></li>--}}
                            {{--                                    </ul>--}}
                            {{--                                </li>--}}
                            {{--                            </ul>--}}
                        </div>
            ...
            <ul>  <!-- SLIDE  -->
                <li data-index="rs-4" data-transition="fade" data-slotamount="default" data-hideafterloop="0" data-hideslideonmobile="off"  data-easein="default" data-easeout="default" data-masterspeed="300"  data-thumb="revolution/assets/100x50_a617d-slider2-bg.jpg"  data-rotate="0"  data-saveperformance="off"  data-title="Slide" data-param1="" data-param2="" data-param3="" data-param4="" data-param5="" data-param6="" data-param7="" data-param8="" data-param9="" data-param10="" data-description="">
                    ...
                    <div class="tp-caption   tp-resizeme"
                         ...
                         data-start="1500"
                         data-responsive_offset="on"
                         style="z-index: 6;"><img src="html/the-zayka/revolution/assets/6ffd8-slide2-img2.png" alt="" data-ww="auto" data-hh="auto" data-no-retina> </div>
                    <!-- LAYER NR. 3 -->
                    <div class="tp-caption   tp-resizeme"
                         id="slide-4-layer-7"
                         ...
                         data-start="1500"
                         data-responsive_offset="on"
                         style="z-index: 7;"><img src="html/the-zayka/revolution/assets/57034-slide2-img3.png" alt="" data-ww="auto" data-hh="auto" data-no-retina> </div>
                    <!-- LAYER NR. 4 -->
                    <div class="tp-caption  text-orange tp-resizeme  text-center"
                         ...
                         data-splitout="none"
                         data-responsive_offset="on"
                         style="z-index: 13; white-space: nowrap; font-size: 65px; line-height: 65px; font-weight: 400; font-family:Lilita One;text-transform:uppercase;"> Mepal food & bakers</div>
                    <!-- LAYER NR. 5 -->
                    <div class="tp-caption   tp-resizeme"
                         id="slide-4-layer-11"
                         ...
                         data-start="4200"
                         data-responsive_offset="on"
                         style="z-index: 9;"><img src="html/the-zayka/revolution/assets/dc11c-slide2-img7.png" alt="" data-ww="auto" data-hh="auto" data-no-retina> </div>
                    <!-- LAYER NR. 6 -->
                    <div class="tp-caption   tp-resizeme"
                         id="slide-4-layer-8"
                         data-x="192"
                         ...
                         data-start="3800"
                         data-responsive_offset="on"
                         style="z-index: 10;"><img src="html/the-zayka/revolution/assets/77f8c-slide2-img4.png" alt="" data-ww="auto" data-hh="auto" data-no-retina> </div>
                    <!-- LAYER NR. 7 -->
                    <div class="tp-caption   tp-resizeme"
                         id="slide-4-layer-3"
                         data-x="center" data-hoffset=""
                         ...
                         data-start="900"
                         data-responsive_offset="on"
                         style="z-index: 11;"><img src="html/the-zayka/revolution/assets/bcac6-slide2-img1.png" alt="" data-ww="auto" data-hh="auto" data-no-retina> </div>
                    <!-- LAYER NR. 8 -->
                    <div class="tp-caption   tp-resizeme"
                         id="slide-4-layer-9"
                         ...
                         data-start="3800"
                         data-responsive_offset="on"
                         style="z-index: 12;"><img src="html/the-zayka/revolution/assets/b4c34-slide2-img5.png" alt="" data-ww="auto" data-hh="auto" data-no-retina> </div>
                    <!-- LAYER NR. 9 -->
                    ...
                    <div class="tp-caption   tp-resizeme"
                         ...
                         data-start="5800"
                         data-responsive_offset="on"
                         style="z-index: 14;"><img src="html/the-zayka/revolution/assets/c78fc-slide2-img6.png" alt="" data-ww="auto" data-hh="auto" data-no-retina> </div>
                    <!-- LAYER NR. 11 -->
                ...
                <li data-index="rs-19" data-transition="fade" data-slotamount="default" data-hideafterloop="0" data-hideslideonmobile="off"  data-easein="default" data-easeout="default" data-masterspeed="300"  data-thumb="revolution/assets/100x50_a617d-slider2-bg.jpg"  data-rotate="0"  data-saveperformance="off"  data-title="Slide" data-param1="" data-param2="" data-param3="" data-param4="" data-param5="" data-param6="" data-param7="" data-param8="" data-param9="" data-param10="" data-description="">
                    ...
                    <div class="tp-caption   tp-resizeme"
                         ...
                         data-start="1500"
                         data-responsive_offset="on"
                         style="z-index: 7;"><img src="html/the-zayka/revolution/assets/bcc28-img5.png" alt="" data-ww="auto" data-hh="auto" data-no-retina> </div>
                    <!-- LAYER NR. 4 -->
                    <div class="tp-caption text-orange tp-resizeme  text-center"
                    ...
                    <div class="tp-caption   tp-resizeme"
                         ...
                         data-start="3800"
                         data-responsive_offset="on"
                         style="z-index: 10;"><img src="html/the-zayka/revolution/assets/2db18-img2.png" alt="" data-ww="auto" data-hh="auto" data-no-retina> </div>
                    <!-- LAYER NR. 7 -->
                    <div class="tp-caption   tp-resizeme"
                         ...
                         data-start="900"
                         data-responsive_offset="on"
                         style="z-index: 11;"><img src="html/the-zayka/revolution/assets/06df7-img6.png" alt="" data-ww="auto" data-hh="auto" data-no-retina> </div>
                    <!-- LAYER NR. 8 -->
                    <div class="tp-caption   tp-resizeme"
                         ...
                         data-start="3800"
                         data-responsive_offset="on"
                         style="z-index: 12;"><img src="html/the-zayka/revolution/assets/32168-img4.png" alt="" data-ww="auto" data-hh="auto" data-no-retina> </div>
                    <!-- LAYER NR. 9 -->
                    <div class="tp-caption tp-resizeme mo-details-text"
                    ...
                    <div class="tp-caption   tp-resizeme"
                         ...
                         data-start="5800"
                         data-responsive_offset="on"
                         style="z-index: 14;"><img src="html/the-zayka/revolution/assets/ef0d8-img3.png" alt="" data-ww="auto" data-hh="auto" data-no-retina> </div>
                    <!-- LAYER NR. 11 -->
                    <div class="tp-caption tp-resizeme mo-sub-title-text"
...
<section class="about white-bg">
    <div class="object-bottom-top">
        <div class="object-left">
            <img class="img-responsive" src="html/the-zayka/images/object/01.jpg" alt="">
        </div>
        <div class="object-right">
            <img class="img-responsive" src="html/the-zayka/images/object/02.jpg" alt="">
        </div>
    </div>
    <div class="page-section-ptb">
        <div class="container">
            <div class="row">
                <div class="col-lg-12 col-md-12">
                    <div class="section-title text-center">
                        ...
                        <h2> <span class="text-orange">Welcome to</span> The Food Mepal & Bakers</h2>
            ...
            {{--                            <img class="img-responsive mt-30" src="html/the-zayka/images/arrow.png" alt="">--}}
            {{--                        </div>--}}
            {{--                    </div>--}}
            ...
            {{--                                                <img class="img-responsive center-block" src="html/the-zayka/images/menu/book-logo.png" alt="">--}}
            {{--                                            </div>--}}
            ...
            {{--                                                            <img class="img-responsive center-block" src="html/the-zayka/images/dish/01.png" alt="">--}}
            {{--                                                        </div>--}}
            ...
            {{--                                                    <div class="menu-body menu-left">--}}
            {{--                                                        <div class="menu-thumbnail">--}}
            {{--                                                            <img class="img-responsive center-block" src="html/the-zayka/images/dish/02.png" alt="">--}}
            {{--                                                        </div>--}}
            {{--                                                        <div class="menu-details">--}}
            {{--                                                            <div class="menu-title clearfix">--}}
            {{--                                                                <h4>PREMIUM CAFE</h4>--}}
            ...
            {{--                                                    <div class="menu-body menu-left">--}}
            {{--                                                        <div class="menu-thumbnail">--}}
            {{--                                                            <img class="img-responsive center-block" src="html/the-zayka/images/dish/03.png" alt="">--}}
            {{--                                                        </div>--}}
            {{--                                                        <div class="menu-details">--}}
            {{--                                                            <div class="menu-title clearfix">--}}
            ...
            {{--                                                    <div class="menu-body menu-left">--}}
            {{--                                                        <div class="menu-thumbnail">--}}
            {{--                                                            <img class="img-responsive center-block" src="html/the-zayka/images/dish/04.png" alt="">--}}
            {{--                                                        </div>--}}
            {{--                                                        <div class="menu-details">--}}
            {{--                                                            <div class="menu-title clearfix">--}}
            {{--                                                                <h4>PREMIUM The Zayka</h4>--}}
            ...
            {{--                                                    <div class="menu-body menu-left">--}}
            {{--                                                        <div class="menu-thumbnail">--}}
            {{--                                                            <img class="img-responsive center-block" src="html/the-zayka/images/dish/05.png" alt="">--}}
            {{--                                                        </div>--}}
            {{--                                                        <div class="menu-details">--}}
            {{--                                                            <div class="menu-title clearfix">--}}
            ...
            {{--                                                    <div class="menu-body menu-left">--}}
            {{--                                                        <div class="menu-thumbnail">--}}
            {{--                                                            <img class="img-responsive center-block" src="html/the-zayka/images/dish/06.png" alt="">--}}
            {{--                                                        </div>--}}
            {{--                                                        <div class="menu-details">--}}
            {{--                                                            <div class="menu-title clearfix">--}}
            {{--                                                                <h4>French Toast</h4>--}}
            ...
            {{--                                                    <div class="menu-body menu-left">--}}
            {{--                                                        <div class="menu-thumbnail">--}}
            {{--                                                            <img class="img-responsive center-block" src="html/the-zayka/images/dish/07.png" alt="">--}}
            {{--                                                        </div>--}}
            {{--                                                        <div class="menu-details">--}}
            {{--                                                            <div class="menu-title clearfix">--}}
            ...
            {{--                                                    <div class="menu-body menu-left">--}}
            {{--                                                        <div class="menu-thumbnail">--}}
            {{--                                                            <img class="img-responsive center-block" src="html/the-zayka/images/dish/08.png" alt="">--}}
            {{--                                                        </div>--}}
            {{--                                                        <div class="menu-details">--}}
            {{--                                                            <div class="menu-title clearfix">--}}
            {{--                                                                <h4>PREMIUM The Zayka</h4>--}}
            ...
            {{--                                                    <div class="menu-body menu-left">--}}
            {{--                                                        <div class="menu-thumbnail">--}}
            {{--                                                            <img class="img-responsive center-block" src="html/the-zayka/images/dish/09.png" alt="">--}}
            {{--                                                        </div>--}}
            {{--                                                        <div class="menu-details">--}}
            {{--                                                            <div class="menu-title clearfix">--}}
            ...
            {{--                                                    <div class="menu-body menu-left">--}}
            {{--                                                        <div class="menu-thumbnail">--}}
            {{--                                                            <img class="img-responsive center-block" src="html/the-zayka/images/dish/10.png" alt="">--}}
            {{--                                                        </div>--}}
            {{--                                                        <div class="menu-details">--}}
            {{--                                                            <div class="menu-title clearfix">--}}
            ...
            {{--                                                    <div class="menu-body menu-left">--}}
            {{--                                                        <div class="menu-thumbnail">--}}
            {{--                                                            <img class="img-responsive center-block" src="html/the-zayka/images/dish/11.png" alt="">--}}
            {{--                                                        </div>--}}
            {{--                                                        <div class="menu-details">--}}
            {{--                                                            <div class="menu-title clearfix">--}}
            {{--                                                                <h4>Eggs Benedict</h4>--}}
            ...
            {{--                                                    <div class="menu-body menu-left">--}}
            {{--                                                        <div class="menu-thumbnail">--}}
            {{--                                                            <img class="img-responsive center-block" src="html/the-zayka/images/dish/12.png" alt="">--}}
            {{--                                                        </div>--}}
            {{--                                                        <div class="menu-details">--}}
            {{--                                                            <div class="menu-title clearfix">--}}
            {{--                                                                <h4>PREMIUM The Zayka</h4>--}}
            ...
            {{--                                                    <div class="menu-body menu-left">--}}
            {{--                                                        <div class="menu-thumbnail">--}}
            {{--                                                            <img class="img-responsive center-block" src="html/the-zayka/images/dish/13.png" alt="">--}}
            {{--                                                        </div>--}}
            {{--                                                        <div class="menu-details">--}}
            {{--                                                            <div class="menu-title clearfix">--}}
            ...
            {{--                                                    <div class="menu-body menu-left">--}}
            {{--                                                        <div class="menu-thumbnail">--}}
            {{--                                                            <img class="img-responsive center-block" src="html/the-zayka/images/dish/14.png" alt="">--}}
            {{--                                                        </div>--}}
            {{--                                                        <div class="menu-details">--}}
            {{--                                                            <div class="menu-title clearfix">--}}
            {{--                                                                <h4>Spring Salad</h4>--}}
            ...
            {{--                                                    <div class="menu-body menu-left">--}}
            {{--                                                        <div class="menu-thumbnail">--}}
            {{--                                                            <img class="img-responsive center-block" src="html/the-zayka/images/dish/15.png" alt="">--}}
            {{--                                                        </div>--}}
            {{--                                                        <div class="menu-details">--}}
            {{--                                                            <div class="menu-title clearfix">--}}
            ...
            {{--                                                    <div class="menu-body menu-left">--}}
            {{--                                                        <div class="menu-thumbnail">--}}
            {{--                                                            <img class="img-responsive center-block" src="html/the-zayka/images/dish/16.png" alt="">--}}
            {{--                                                        </div>--}}
            {{--                                                        <div class="menu-details">--}}
            {{--                                                            <div class="menu-title clearfix">--}}
            {{--                                                                <h4>PREMIUM The Zayka</h4>--}}
...
<!--=================================
special-menu -->
{{--<section class="special-menu parallax" style="background-image: url(html/the-zayka/images/bg/01.jpg);">--}}
{{--    <div class="page-section-ptb">--}}
{{--        <div class="container">--}}
{{--            <div class="row">--}}
{{--                <div class="col-lg-12 col-md-12">--}}
...
<!--=================================
our-menu -->
<section class="our-menu page-section-pt parallax pb-30" style="background-image: url(html/the-zayka/images/bg/06.jpg);">
    <div class="container">
        <div class="row">
            <div class="col-sm-12">
...
<!--=================================
reservation form  -->
<!-- <section class="reservation-form contact-form dark page-section-ptb parallax bg-overlay-black-80" style="background-image: url(html/the-zayka/images/bg/02.jpg);">
  <div class="container">
    <div class="row">
      <div class="col-lg-12">
        <div class="section-title text-center">
    ...
    <div class="row row-eq-height">
      <div class="col-lg-4 col-md-5 pl-0 pr-0">
        <div class="reservation-image form-image">
          <img class="img-responsive" src="html/the-zayka/images/event/07.jpg" alt="">
        </div>
      </div>
...
<!-- <section class="testimonials">
  <div class="object-bottom-top">
    <div class="object-right">
      <img class="img-responsive" src="html/the-zayka/images/object/05.png" alt="">
    </div>
  </div>
  <div class="page-section-ptb">
    <div class="container">
      ...
      <div class="row">
        <div class="col-lg-4 col-md-4">
          <div class="testimonial-block left">
            <div class="testimonial-avatar">
              <img src="html/the-zayka/images/team/01.jpg" alt="">
            </div>
        ...
        <div class="col-lg-4 col-md-4">
          <div class="testimonial-block left">
            <div class="testimonial-avatar">
              <img src="html/the-zayka/images/team/02.jpg" alt="">
            </div>
            <div class="testimonial-info clearfix">
        ...
        <div class="col-lg-4 col-md-4">
          <div class="testimonial-block left">
            <div class="testimonial-avatar">
              <img src="html/the-zayka/images/team/03.jpg" alt="">
            </div>
            <div class="testimonial-info clearfix">
    ...
    <div class="row">
      <div class="col-lg-4 col-md-4">
        <div class="newsletter-image">
          <img class="img-responsive center-block" src="html/the-zayka/images/object/15.png" alt="">
        </div>
      </div>
        ...
        <div class="row">
            <div class="col-lg-12 col-md-12 text-center mt-60">
                <div class="footer-logo">
                    <img id="logo-footer" class="img-responive" src="html/the-zayka/images/logo.png" alt="">
                </div>
                <div class="col-lg-8 col-lg-offset-2">
...
jquery -->
<!-- jquery  -->
<script type="text/javascript" src="html/the-zayka/js/jquery.min.js"></script>
<!-- bootstrap -->
<script type="text/javascript" src="html/the-zayka/js/bootstrap.min.js"></script>
<!-- mega menu -->
<script type="text/javascript" src="html/the-zayka/js/mega-menu/mega_menu.js"></script>
<!-- owl carousel -->
<script type="text/javascript" src="html/the-zayka/js/owl.carousel.min.js"></script>
<!-- appear -->
<script type="text/javascript" src="html/the-zayka/js/jquery.appear.js"></script>
<!-- counter -->
<script type="text/javascript" src="html/the-zayka/js/counter/jquery.countto.js"></script>
<!-- datepicker -->
<script type="text/javascript" src="html/the-zayka/js/datepicker/bootstrap-datetimepicker.min.js"></script>
<!-- open menu -->
<script type="text/javascript" src="html/the-zayka/js/book/modernizr.custom.js"></script>
<script type="text/javascript" src="html/the-zayka/js/book/bookblock.min.js"></script>
<!-- nicescroll -->
<script type="text/javascript" src="html/the-zayka/js/jquery.nicescroll.min.js"></script>
<!-- select -->
<script type="text/javascript" src="html/the-zayka/js/jquery-select.js"></script>
<!-- REVOLUTION JS FILES -->
<script type="text/javascript" src="html/the-zayka/revolution/js/jquery.themepunch.tools.min.js"></script>
<script type="text/javascript" src="html/the-zayka/revolution/js/jquery.themepunch.revolution.min.js"></script>
<!-- SLIDER REVOLUTION 5.0 EXTENSIONS
(Load Extensions only on Local File Systems !
The following part can be removed on Server for On Demand Loading) -->
<script type="text/javascript" src="html/the-zayka/revolution/js/extensions/revolution.extension.actions.min.js"></script>
<script type="text/javascript" src="html/the-zayka/revolution/js/extensions/revolution.extension.carousel.min.js"></script>
<script type="text/javascript" src="html/the-zayka/revolution/js/extensions/revolution.extension.kenburn.min.js"></script>
<script type="text/javascript" src="html/the-zayka/revolution/js/extensions/revolution.extension.layeranimation.min.js"></script>
<script type="text/javascript" src="html/the-zayka/revolution/js/extensions/revolution.extension.migration.min.js"></script>
<script type="text/javascript" src="html/the-zayka/revolution/js/extensions/revolution.extension.navigation.min.js"></script>
<script type="text/javascript" src="html/the-zayka/revolution/js/extensions/revolution.extension.parallax.min.js"></script>
<script type="text/javascript" src="html/the-zayka/revolution/js/extensions/revolution.extension.slideanims.min.js"></script>
<script type="text/javascript" src="html/the-zayka/revolution/js/extensions/revolution.extension.video.min.js"></script>
<!-- SLIDER REVOLUTION CUSTOM  -->
<script type="text/javascript" src="html/the-zayka/revolution/js/revolution-custom.js"></script>
<!-- style customizer  -->
<script type="text/javascript" src="html/the-zayka/js/style-customizer.js"></script>
<!-- custom -->
<script type="text/javascript" src="html/the-zayka/js/custom.js"></script>
</html>
